...
In readonly mode the editor switches to view mode with a minimal toolbar, suitable for embedding previews:

```
?src=https://example.com/report.xlsx&readonly=true
```
